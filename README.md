- MIB là gì
      ...
      MIB định nghĩa các đối tượng (objects) mà hệ thống quản lý có thể truy vấn thông qua SNMP. Mỗi đối tượng trong MIB có một định danh duy nhất được gọi là Object Identifier (OID).
